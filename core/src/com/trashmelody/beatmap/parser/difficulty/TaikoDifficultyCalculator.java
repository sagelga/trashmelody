...
import com.trashmelody.beatmap.parser.beatmap.taiko.TaikoCircle;
import com.trashmelody.beatmap.parser.beatmap.taiko.TaikoObject;
	...
	class DifficultyObject {
		...
		DifficultyObject(TaikoObject object) {
			...
			if (object instanceof TaikoCircle)
				isBlue = ((TaikoCircle) object).getColor() == TaikoCircle.TaikoColor.BLUE;
		}
