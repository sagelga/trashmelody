...
public class BeatmapGroupId {

    public static final String HITORIGOTO_BEATMAP_GROUP_ID = "599387";
    public static final String MARBLE_SODA_BEATMAP_GROUP_ID = "387784";
